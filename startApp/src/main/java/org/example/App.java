...
public class App {
    public static void main(String[] args) {
        ...
        String mr231_TTM = "$RATTM,66,28.71,341.1,T,57.6,024.5,R,0.4,4.1,N,b,L,,457362,А*42";
        String mr231_VHW = "$RAVHW,115.6,T,,,46.0,N,,*71";
        String mr231_RSD = "$RARSD,36.5,331.4,8.4,320.6,,,,,11.6,185.3,96.0,N,N,S*20";
        ...
        String mr231_3_RSD = "$RARSD,36.5,331.4,8.4,320.6,,,,,11.6,185.3,96.0,N,N,S*20";
        ...
        List<SearadarStationMessage> searadarStationMessages = converter_3.convert(mr231_3_TTM);
        searadarStationMessages.forEach(System.out::println);
        searadarStationMessages = converter_3.convert(mr231_3_RSD);
        searadarStationMessages.forEach(System.out::println);
    }
}
